...
def test_lifespan_initializes_database(client, db_engine):
    ...
    assert set(Base.metadata.tables) == {"users", "plans", "resources", "resource_availability", "tasks", "task_requirements", "task_dependencies", "constraint_rules", "solver_runs", "planning_memories", "habit_candidates"}
